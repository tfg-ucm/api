...
router.get('/:ciudad', isAuthenticated, beaconsController.getByCiudad);
router.get('/:ruta', isAuthenticated, beaconsController.getByRuta);
...
router.post('/validate', isAuthenticated, beaconsController.validate);
